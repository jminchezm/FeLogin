...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->linkLabel1->Location = System::Drawing::Point(117, 371);
			...
			this->label1->Location = System::Drawing::Point(46, 339);
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (txtDpi->Text == "" || txtNombre1->Text == "" || txtNombre2->Text == "" || txtApellido1->Text == "" || txtApellido2->Text == "" || numEdad->Text == "" || cboSexo->Text == "" || txtTelefono->Text == "" || txtDireccion->Text == "") {
		MessageBox::Show("POR FAVOR, LLENE TODOS LOS CAMPOS. SON OBLIGATORIOS", "INFORMACION", MessageBoxButtons::OK, MessageBoxIcon::Information);
	}
	else
	{
